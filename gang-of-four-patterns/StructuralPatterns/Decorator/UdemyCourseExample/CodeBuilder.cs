...
using System.Text;
/// <summary>
/// We want to create a custom variant of <see cref="StringBuilder"/>.
/// Usually you would do this by just inheriting from <see cref="StringBuilder"/>
/// and then just extending the functionality.
/// But <see cref="StringBuilder"/> is **sealed**.
/// In order to solve this we build a **Decorator**.
/// </summary>
public class CodeBuilder
{
    private readonly StringBuilder _builder = new();

    // Then we implement delegating members for the
    // StringBuilder API.
